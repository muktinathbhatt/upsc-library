...
const concepts=[
 ...
 {terms:['economic growth','growth'],label:'Economic growth',note:'A sustained increase in real output or income; it is distinct from the broader transformation implied by development.',example:'High growth can coexist with weak employment creation or unequal gains.'},
